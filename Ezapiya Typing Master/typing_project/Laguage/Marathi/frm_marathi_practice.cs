...
{
    public partial class frm_marathi_practice : Form
    {
        ...
        private void frm_marathi_proctic_Load(object sender, EventArgs e)
        {
            ...
            String sql = "select * from marathi where  tital='" + Globle_data.chapter + "'";
        ...
        private void frm_marathi_practice_FormClosed(object sender, FormClosedEventArgs e)
        {
        ...
        {
            Process.Start("http://ditrpindia.com/typingsoftware");
        }
